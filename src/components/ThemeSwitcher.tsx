...
export const ThemeSwitcher: React.FC = () => {
  ...
  return (
    <button
      ...
      title={title}
      className="ml-3 w-10 h-10 rounded-full flex items-center justify-center bg-surface-container-highest-40 hover:bg-surface-container-highest-60 transition-colors"
    >
      <MaterialIcon icon={icon} ariaLabel={`Theme: ${theme}`} className="text-[18px]" />
    </button>
  );
};
